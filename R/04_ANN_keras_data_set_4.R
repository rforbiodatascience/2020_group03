...
# Save plot
<<<<<<< HEAD
ggsave(plot = plot_lm, "./results/06_ann/linear_regression_data_set_4.png")

# Save model
save(model, file="./results/06_ann/linear_regression_data_set_4.Rdata")
=======
ggsave(plot = plot_lm, "./results/06_ANN_plots/prelm_data_set_4.png")

# Save model
save(model, file="./results/06_ANN_data/prelm_data_set_4.Rdata")
>>>>>>> 426fe94df338df0b72d0cf403eed77bc6634029e
...
<<<<<<< HEAD
ggsave(plot = ann_keras_data_set_4, "./results/06_ann/ann_keras_data_set_4.png")

# Save model
# ------------------------------------------------------------------------------

save_model_hdf5(object = model,
                filepath = "./results/06_ann/ann_keras_ds4.h5")

# Load the model (Note the use of the custom_objects argument)
loaded_model = load_model_hdf5(filepath = './results/06_ann/ann_keras_ds4.h5',
=======
