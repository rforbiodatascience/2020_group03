...
# Save quickSAR plots
# ------------------------------------------------------------------------------
ggsave(plot = quick_sar_data_set_1, "./results/quick_SAR/quick_sar_data_set_1.png",width = 10, height = 3, dpi=300)
ggsave(plot = quick_sar_data_set_2, "./results/quick_SAR/quick_sar_data_set_2.png",width = 10, height = 3, dpi=300)
ggsave(plot = quick_sar_data_set_3, "./results/quick_SAR/quick_sar_data_set_3.png",width = 10, height = 3, dpi=300)
ggsave(plot = quick_sar_data_set_4, "./results/quick_SAR/quick_sar_data_set_4.png",width = 10, height = 3, dpi=300)