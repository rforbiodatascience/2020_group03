...
# Save model
save(model, file="./results/06_ann/linear_regression_data_set_1.Rdata")
...
save_model_hdf5(object = model,
                filepath = "./results/06_ann/ann_keras_ds1.h5")

# Load the model (Note the use of the custom_objects argument)
loaded_model = load_model_hdf5(filepath = './results/06_ann/ann_keras_ds1.h5',
