...
# Save plot
ggsave(plot = plot_lm, "./results/06_ANN_plots/prelm_data_set_1.png")

# Save model
save(model, file="./results/06_ANN_data/prelm_data_set_1.Rdata")
...
ggsave(plot = ann_keras_data_set_1, "./results/06_ANN_plots/ann_keras_data_set_1.png")

# Save model
# ------------------------------------------------------------------------------

save_model_hdf5(object = model,
                filepath = "./results/06_ANN_data/ann_keras_ds1.h5")

# Load the model (Note the use of the custom_objects argument)
loaded_model = load_model_hdf5(filepath = './results/06_ANN_data/ann_keras_ds1.h5',
