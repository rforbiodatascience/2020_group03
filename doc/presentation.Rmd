...
![](../results/06_ANN_plots/ann_keras_data_set_4.png){width=100%}
...
![](../results/07_predict/07_density_data_set_4.png){width=50%}



## Discussion and model comparison for all four data sets
<div class="columns-2">
* For all four data sets 4 we compared ANN and glmnet regression (ElasticNet) on two amino acid descriptor scales.
 ...
 * The ANN with keras was performed for 4 data sets obtaining a really low accuracy for all of them. It was necessary to downsize the datasets, taking 1/4 of the sequence, in order to obtain a final model in each case.
