...
output:
  ioslides_presentation:
    widescreen: true
    smaller: true
    logo: ./external_figures/r_for_bio_data_science_hex_logo_quadratic_small.png
...
## Example data set 1 - data overview

<div class="columns-2">
 ![](../results/04_density_plots/density_data_set_1.png){width=100%}
  <p class="forceBreak">
     </p>
   ![](../results/04_density_plots/density_residue_data_set_1.png){width=100%}
</div>

## Example dataset 1 - heatmap
![](../results/04_heatmaps/heatmap_data_set_score_1.png){width=100%}
![SEQUENCE LOGO CHANGE](../results/04_heatmaps/heatmap_data_set_score_1.png){width=100%}
## Example dataset 1 - conserved regions
